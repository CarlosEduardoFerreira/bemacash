...
public class SaleOrderViewModel extends SaleOrderModel{
    ...
    public SaleOrderViewModel(String guid, Date createTime, String operatorGuid, String shiftGuid, String customerGuid, BigDecimal discount, DiscountType discountType, OrderStatus orderStatus,
                              ...
                              String customerName, String customerPhone, String customerEmail, BigDecimal tipsAmount, KitchenPrintStatus kitchenPrintStatus, PrintOrderToKdsCommand.KDSSendStatus kdsSendStatus, boolean onRegister, BigDecimal transactionFee, int ageVerified) {
        super(guid, createTime, operatorGuid, shiftGuid, customerGuid, discount, discountType, orderStatus, holdName, definedOnHoldGuid, holdPhone, holdStatus, taxable, tmpTotalPrice, tmpTotalTax, tmpTotalDiscount, printSeqNum, registerId, parentId, type, isTipped, kitchenPrintStatus, kdsSendStatus, transactionFee, onRegister, ageVerified, null);
