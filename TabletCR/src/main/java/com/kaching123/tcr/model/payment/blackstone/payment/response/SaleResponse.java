 ...
 *       Sale Response datamodel
 */
public class SaleResponse extends ResponseBase {
    ...
    @Expose
    @SerializedName(WebAPI.BlackStoneAPI.LAST_FOUR)
    ...
    public SaleResponse(String avs,
                        String cv,
    ...
    public static Parcelable.Creator<SaleResponse> CREATOR = new Parcelable.Creator<SaleResponse>() {
        ...
        public SaleResponse createFromParcel(Parcel source) {
            ...
            String lastFour = source.readString();
            return new SaleResponse(avs,
                                    cv,
                                    msg,
                                    msoft_code,
                                    paymentPlanInfo,
