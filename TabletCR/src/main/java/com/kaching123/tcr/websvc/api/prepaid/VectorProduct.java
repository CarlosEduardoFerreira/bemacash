...
public class VectorProduct extends Vector<Product> implements KvmSerializable, Serializable {
    
    
    public VectorProduct(){}
    
    public VectorProduct(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
