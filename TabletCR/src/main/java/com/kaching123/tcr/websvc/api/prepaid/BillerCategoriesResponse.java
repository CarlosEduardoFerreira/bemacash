...
public class BillerCategoriesResponse implements KvmSerializable, Serializable {
    
    public long resultId;
    public String resultDescription;
    public VectorCategory categories;
    
    public BillerCategoriesResponse(){}
    
    public BillerCategoriesResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("Categories"))
        {
            ...
            categories = new VectorCategory(j);
        }
    }
    @Override
