...
public class VectorCategory extends Vector<Category> implements KvmSerializable, Serializable {
    
    
    public VectorCategory(){}
    
    public VectorCategory(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
