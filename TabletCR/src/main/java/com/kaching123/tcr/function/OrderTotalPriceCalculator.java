...
public final class OrderTotalPriceCalculator {
    ...
    public static SaleOrderCostInfo calculate(SaleOrderInfo info, Handler2 handler) {
        ...
        for (SaleItemInfo i2 : map.values()) {
            ...
            Log.d("BemaCarl20", "OrderTotalPriceCalculator.itemFinalPrice         5.2: " + itemFinalPrice);
        ...
        Log.d("BemaCarl20", "OrderTotalPriceCalculator.itemSubTotal         4: " + itemSubTotal);
        Log.d("BemaCarl20", "OrderTotalPriceCalculator.itemDiscountTotal    4: " + itemDiscountTotal);
        Log.d("BemaCarl20", "OrderTotalPriceCalculator.tmpOderDiscountVal   4: " + tmpOderDiscountVal);
        Log.d("BemaCarl20", "OrderTotalPriceCalculator.orderTax             4: " + orderTax);
        Log.d("BemaCarl20", "OrderTotalPriceCalculator.orderTotal           4: " + orderTotal);
    ...
    public static SaleOrderCostInfo calculate3(SaleOrderInfo info, Handler2 handler) {
        ...
        for (CalcItemInfo ci : calcItems) {
            ...
            itemFinalPrice2 = itemFinalPrice2.setScale(8, RoundingMode.HALF_UP);
            ...
            Log.d("BemaCarl17","OrderTotalPriceCalculator.totalOrderPrice         2: " + totalOrderPrice);
            Log.d("BemaCarl17","OrderTotalPriceCalculator.totalItemTaxVatValue    2: " + totalItemTaxVatValue);
            Log.d("BemaCarl17","OrderTotalPriceCalculator.totalEbtOrderPrice      2: " + totalEbtOrderPrice);
            Log.d("BemaCarl17","OrderTotalPriceCalculator.itemFinalPrice          2: " + itemFinalPrice);
            Log.d("BemaCarl17","OrderTotalPriceCalculator.itemFinalDiscount       2: " + itemFinalDiscount);
            Log.d("BemaCarl17","OrderTotalPriceCalculator.itemTotal               2: " + itemTotal);

            Log.d("BemaCarl17","OrderTotalPriceCalculator.subTotalItemTotal       2: " + subTotalItemTotal);
            Log.d("BemaCarl17","OrderTotalPriceCalculator.totalItemDiscount       2: " + totalItemDiscount);
            Log.d("BemaCarl17","OrderTotalPriceCalculator.tmpOderDiscountVal      2: " + tmpOderDiscountVal);
        ...
        Log.d("BemaCarl17","OrderTotalPriceCalculator.totalOrderPrice     3: " + totalOrderPrice);
        Log.d("BemaCarl17","OrderTotalPriceCalculator.subTotalItemTotal   3: " + subTotalItemTotal);
        Log.d("BemaCarl17","OrderTotalPriceCalculator.totalItemDiscount   3: " + totalItemDiscount);
        Log.d("BemaCarl17","OrderTotalPriceCalculator.tmpOderDiscountVal  3: " + tmpOderDiscountVal);
    ...
    public static SaleOrderCostInfo calculate2(SaleOrderInfo info, Handler2 handler) {
        ...
        for (SaleItemInfo i2 : map.values()) {
            ...
            itemFinalPrice              = itemFinalPrice.subtract(itemFinalPriceDiscount);
            //totalDiscountableItemTotal  = totalDiscountableItemTotal.subtract(totalItemDiscount);
        ...
        BigDecimal tmpOderDiscountVal = BigDecimal.ZERO;
        if (orderDiscount.compareTo(zeroDecimals) == 1) {
            tmpOderDiscountVal = CalculationUtil.getDiscountValue(totalDiscountableItemTotal, orderDiscount, orderDiscountType);
        }
        //tmpOderDiscountVal = tmpOderDiscountVal.add(totalItemDiscount);
