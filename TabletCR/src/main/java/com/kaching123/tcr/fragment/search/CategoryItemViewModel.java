...
public class CategoryItemViewModel extends ItemExModel{
    ...
    public CategoryItemViewModel(String guid, String categoryId, String description, String code, String eanCode, String productCode, PriceType priceType,
                                 BigDecimal price, BigDecimal qty, String unitsLabel, boolean isStockTracking, boolean isActiveStatus,
                                 boolean isDiscountable, BigDecimal discount, DiscountType discountType, boolean isTaxable,
        ...
        super(guid, categoryId, description, code, eanCode, productCode, priceType, price, qty, unitsLabel, isStockTracking, isActiveStatus, isDiscountable,
