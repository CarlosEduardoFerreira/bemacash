...
public class CategoryItemViewModel extends ItemExModel{
    ...
    public CategoryItemViewModel(String guid, String categoryId, String description, String code, String eanCode, String productCode, PriceType priceType,
                                 ...
                                 boolean isSalable,
                                 BigDecimal discount, DiscountType discountType, boolean isTaxable,
        ...
        super(guid, categoryId, description, code, eanCode, productCode, priceType, price, qty, unitsLabel, isStockTracking, isActiveStatus,
                isDiscountable,
                isSalable,
