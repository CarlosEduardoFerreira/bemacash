...
//            callback.onBillingSuccess(BaseCashierActivity.this, releaseResult);
    ...
    protected void onStop() {
        ...
        if (isCreateReturnOrder && !TextUtils.isEmpty(orderGuid)) {
            RemoveSaleOrderCommand.start(SuperBaseCashierActivity.this, SuperBaseCashierActivity.this, SuperBaseCashierActivity.this.orderGuid);
        }
    }
    ...
    protected void tryToAddItem(final ItemExModel model, final BigDecimal price, final BigDecimal quantity, final Unit unit) {
        ...
        if(!model.hasModificators() && !checkTrackedQty(model)){
            ...
            ItemsNegativeStockTrackingCommand.start(SuperBaseCashierActivity.this, model.getGuid(), ItemsNegativeStockTrackingCommand.ItemType.COMPOSITION, new ItemsNegativeStockTrackingCommand.NegativeStockTrackingCallback() {
                @Override
                protected void handleSuccess(boolean result) {
                    if(!result){
                        Toast.makeText(SuperBaseCashierActivity.this, R.string.item_qty_lower_zero, Toast.LENGTH_SHORT).show();
                        return;
                    }
                    CollectModifiersCommand.start(SuperBaseCashierActivity.this, model.guid, null, price, model, quantity, unit, true, collectionCallback);
                }
            });
        } else {
    ...
    public CollectModifiersCommand.BaseCollectModifiersCallback collectionCallback = new CollectModifiersCommand.BaseCollectModifiersCallback() {
        ...
        public void onCollected(final ArrayList<CollectModifiersCommand.SelectedModifierExModel> modifiers, final ItemExModel model, final BigDecimal price, final BigDecimal quantity, final Unit unit, boolean hasAutoApply) {
            ...
            if (hasAutoApply) {
                ItemsNegativeStockTrackingCommand.start(SuperBaseCashierActivity.this, ItemsNegativeStockTrackingCommand.ItemType.MODIFIER, model.getGuid(),  getModifiers(modifiers), null, null,
            ...
            ModifyFragment.show(SuperBaseCashierActivity.this,
                    model.guid,
                    new ItemModifiersFragment.OnAddonsChangedListener() {
                        ...
                        public void onAddonsChanged(final ArrayList<String> modifierGuid,
                            ...
                            ItemsNegativeStockTrackingCommand.start(SuperBaseCashierActivity.this, ItemsNegativeStockTrackingCommand.ItemType.MODIFIER, model.getGuid(), modifierGuid, addonsGuid, optionalsGuid,
                                    new ItemsNegativeStockTrackingCommand.NegativeStockTrackingCallback() {
                                        @Override
                                        protected void handleSuccess(boolean result) {
                                            if (!result) {
...
//                disconnectScanner();
            playAlarm();
            AlertDialogFragment.show(SuperBaseCashierActivity.this,
                    ...
                    new StyledDialogFragment.OnDialogClickListener() {
                        ...
                        public boolean onClick() {
                            ...
                            if (!inventoryPermitted) {
                                PermissionFragment.showCancelable(SuperBaseCashierActivity.this, new BaseTempLoginListener(SuperBaseCashierActivity.this) {
                                    @Override
...
//            orderPrinted = true;
//            printReceipts();
            WaitDialogFragment.hide(SuperBaseCashierActivity.this);
        }

        @Override
        public void onPrintError(PrinterCommand.PrinterError errorType) {
            PrintCallbackHelper2.onPrintError(SuperBaseCashierActivity.this, errorType, callback);
        }

        @Override
        public void onPrinterNotConfigured() {
            PrintCallbackHelper2.onPrinterNotConfigured(SuperBaseCashierActivity.this, callback);
        }

        @Override
        public void onPrinterDisconnected() {
            PrintCallbackHelper2.onPrinterDisconnected(SuperBaseCashierActivity.this, callback);
        }

        @Override
        protected void onPrinterIPnotFound() {
            PrintCallbackHelper2.onPrinterIPnotFound(SuperBaseCashierActivity.this, callback);
        }

        @Override
        public void onPrinterPaperNearTheEnd() {
            PrintCallbackHelper2.onPrinterPaperNearTheEnd(SuperBaseCashierActivity.this, callback);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        lockItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                WaitDialogFragment.show(SuperBaseCashierActivity.this, getString(R.string.wait_printing));
                for (int i = 0; i < getApp().getShopPref().printReceiptTwice().get(); i++)
                    PrintOrderCommand.start(SuperBaseCashierActivity.this, false, false, orderGuid, printOrderCallback, orderTitle, totalCostGetOrderSubTotal(), totalCostGetOrderDiscountTotal(), totalCostGetOrderTaxTotal(), totalCostGetOrderAmountTotal());
                return true;
            }
        });
...
//                show(SuperBaseCashierActivity.this, getString(R.string.prepaid_dialog_des), new PrepaidListAdapter(getData()));

                try {
                    callPrepaidMini(PREPAID_MINI_START, PREPAID_MINI_START_ALL);
                    return false;
                } catch (ActivityNotFoundException exception) {
                    AlertDialogFragment.showAlert(SuperBaseCashierActivity.this,
        ...
        giftcardItem.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (!getApp().isPaxConfigured()) {
                    AlertDialogFragment.showAlert(SuperBaseCashierActivity.this, R.string.error_dialog_title, getString(R.string.gift_card_require_pax_configure));
                } else {
                    GiftCardFragmentDialog.show(SuperBaseCashierActivity.this, new GiftCardFragmentDialog.IGiftCardListener() {
                        @Override
                        public void onReload() {

                            GiftCardAmountFragmentDialog.show(SuperBaseCashierActivity.this, new GiftCardAmountFragmentDialog.IGiftCardListener() {
                                @Override
                        ...
                        public void onSuccess() {
                            GiftCardFragmentDialog.hide(SuperBaseCashierActivity.this);
                        }
                    });
                }
                return false;
    ...
    class PrepaidListAdapter extends BaseAdapter {
        ...
        PrepaidListAdapter(ArrayList<String> list) {
            this.list = list;
            this.mInflater = LayoutInflater.from(SuperBaseCashierActivity.this);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.name.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        DialogUtil.hide(SuperBaseCashierActivity.this, DIALOG_NAME);
                        callPrepaidMini(PREPAID_MINI_START, PREPAID_MINI_START_ALL);
    ...
    protected void initSearchView() {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                KeyboardUtils.hideKeyboard(SuperBaseCashierActivity.this, searchView);
                return true;
            }
    ...
    private void itemNotPerfect(final String barcode, final boolean fromScanner,
                                final ItemExModel itemExModel, final Unit unit,
                                final BigDecimal price, final BigDecimal quantity) {
        AlertDialogWithCancelFragment.showWithTwo(SuperBaseCashierActivity.this,
    ...
    private void itemAlreadyIn() {
        AlertDialogWithCancelFragment.show(SuperBaseCashierActivity.this,
                R.string.wireless_already_item_title,
    ...
    private void doubleCheck(final String barcode, final boolean fromScanner,
        ...
        UnitOrderDoubleCheckCommand.start(SuperBaseCashierActivity.this, unit, orderGuid, new UnitOrderDoubleCheckCommand.UnitCallback() {
            @Override
        ...
        if (barcode.length() >= TcrApplication.BARCODE_MIN_LEN) {
            new SearchBarcodeLoader(this, nextBarcodeLoaderId(), barcode) {
                ...
                protected void onMultipleSerialCodeFound(final List<Unit> unitList, final ItemExModel model) {
                    ...
                    AlertDialogFragment.showNotification(SuperBaseCashierActivity.this,
...
//        }
        ...
        if (!getApp().hasPermission(Permission.SALES_HISTORY)) {
            PermissionFragment.showCancelable(this, new BaseTempLoginListener(this) {
                ...
                public void onLoginComplete() {
                    super.onLoginComplete();
                    HistoryActivity.start(SuperBaseCashierActivity.this);
                }
            }, Permission.ADMIN);
            return;
        } else {
    ...
    protected void actionCommissionSelected() {
        CommissionDialog.show(this, salesmanGuids, new CommissionDialog.ICommissionDialogListener() {
            ...
            public void onSalesmanPicked(HashSet<String> salesmanGuids) {
                SuperBaseCashierActivity.this.salesmanGuids = salesmanGuids;
            }
        });
    }
    ...
    private void tryToAddSerializedItem(final ItemExModel model,
        ...
        UnitsSaleFragment.show(SuperBaseCashierActivity.this, model, null, UnitsSaleFragment.UnitActionType.ADD_TO_ORDER,
                model.codeType, new UnitsSaleFragment.UnitSaleCallback() {

                    @Override
                    public void handleSuccess(final Unit unit) {
                        Toast.makeText(SuperBaseCashierActivity.this, getString(R.string.unit_edit_completed), Toast.LENGTH_SHORT).show();
                    ...
                    public void handleError(String message) {
                        ItemsNegativeStockTrackingCommand.start(SuperBaseCashierActivity.this, ItemsNegativeStockTrackingCommand.ItemType.REMOVE, model.getGuid(), modifierGiud, addonsGuids, optionalGuids, null);
                        disconnectScanner();
                        AlertDialogWithCancelFragment.show(SuperBaseCashierActivity.this,
                                R.string.wireless_already_item_title,
                                message,
                    ...
                    private void hide() {
                        UnitsSaleFragment.hide(SuperBaseCashierActivity.this);
                    }
    ...
    private void skipDrawerStateCheck(final ItemExModel model, final ArrayList<String> modifierGiud, final ArrayList<String> addonsGuids, final ArrayList<String> optionalGuids, final BigDecimal price, final BigDecimal quantity, final Unit unit) {
        if (!getApp().hasPermission(Permission.DROPS_AND_PAYOUTS)) {
            PermissionFragment.showCancelable(SuperBaseCashierActivity.this,
                    new StyledDialogFragment.OnDialogClickListener() {
                    ...
                    new BaseTempLoginListener(SuperBaseCashierActivity.this) {
                        @Override
                        public void onLoginComplete() {
                            super.onLoginComplete();
    ...
    private void showDrawerStateErrorDialog(final ItemExModel itemModel, final ArrayList<String> modifierGiud, final ArrayList<String> addonsGuids, final ArrayList<String> optionalGuids, final BigDecimal price, final BigDecimal quantity, final Unit unit) {
        AlertDialogFragment.showAlertWithSkip(SuperBaseCashierActivity.this, R.string.error_dialog_title, getString(R.string.check_drawer_state_error_dialog_message), R.string.btn_retry,
                new StyledDialogFragment.OnDialogClickListener() {
                    @Override
                    public boolean onClick() {
    ...
    public void onPay() {
        ...
        if (saleOrderModel == null || TextUtils.isEmpty(orderGuid)) {
            ...
            StartTransactionCommand.start(SuperBaseCashierActivity.this);
    ...
    private void doPayment() {
        ...
        isPaying = true;
        StartTransactionCommand.start(SuperBaseCashierActivity.this, orderGuid);
        processor = PaymentProcessor.create(orderGuid, OrderType.SALE, saleOrderModel.kitchenPrintStatus, salesmanGuids.toArray(new String[salesmanGuids.size()]))
                .callback(new PaymentProcessor.IPaymentProcessor() {
                    ...
                    public void onSuccess() {
                        ...
                        EndTransactionCommand.start(SuperBaseCashierActivity.this, true);
                        isPaying = false;
                        completeOrder();
                        checkOfflineMode();
                    }
                    ...
                    @Override
                    public void onCancel() {
                        UpdateSaleOrderTaxStatusCommand.start(SuperBaseCashierActivity.this, orderGuid, true,
                        ...
                        EndTransactionCommand.start(SuperBaseCashierActivity.this);
                        isPaying = false;
            ...
            PAXReloadFragmentDialog.show(this, new PAXReloadFragmentDialog.IPaxReloadListener() {
                ...
                public void onComplete(String msg, String balance) {
                    if (PaxProcessorGiftCardReloadCommand.SUCCESS.equalsIgnoreCase(msg)) {
                        ...
                        PAXReloadFragmentDialog.hide(SuperBaseCashierActivity.this);
                    } else {
...
//                    else {
//                        processor.proceedToTipsApply(SuperBaseCashierActivity.this, successfullCCtransactionModels);
//                    }
                }
...
//                    });
    ...
    private void ProceedToGiftCard(boolean success, SaleOrderItemViewModel model, String balance) {
        ...
        if (giftcardCount == 0) {
            ...
            processor.proceedToGiftCard(SuperBaseCashierActivity.this, successfullCCtransactionModels, giftCardResultList);
    ...
    private LoaderManager.LoaderCallbacks<ArrayList<PaymentTransactionModel>> refundTransactionsLoaderCallback = new LoaderManager.LoaderCallbacks<ArrayList<PaymentTransactionModel>>() {
        ...
        public Loader<ArrayList<PaymentTransactionModel>> onCreateLoader(int loaderId, Bundle args) {
            return ReadPaymentTransactionsFunction.createLoaderOnlySaleOrderByAmount(SuperBaseCashierActivity.this, orderGuid);
        }
        ...
        public void onLoadFinished(Loader<ArrayList<PaymentTransactionModel>> listLoader, final ArrayList<PaymentTransactionModel> transactions) {
            getWindow().getDecorView().post(new Runnable() {
                @Override
                public void run() {
                    processor.initRefund(SuperBaseCashierActivity.this, transactions, amount);
                }
            });
        }
    ...
    private void try2ClockIn() {
        WaitDialogFragment.show(SuperBaseCashierActivity.this, getString(R.string.wait_message_clock_in));
        ClockInCommand.start(SuperBaseCashierActivity.this, getApp().getOperatorLogin()/*, password*/, new ClockInCommand.BaseClockInCallback() {
            @Override
            protected void onClockIn(String guid, String fullName, Date time) {
                ...
                AlertDialogFragment.showComplete(SuperBaseCashierActivity.this, R.string.btn_clock_in,
            ...
            protected void onClockInError(ClockInCommand.ClockInOutError error) {
                ...
                AlertDialogFragment.showAlert(SuperBaseCashierActivity.this, R.string.error_dialog_title, getString(messageId));
            }
        });
    }
    ...
    private void checkOfflineMode() {
        ...
        if (getApp().isOfflineModeExpired()) {
            AlertDialogFragment.show(this, AlertDialogFragment.DialogType.ALERT, R.string.offline_mode_error_dialog_title, getString(R.string.offline_mode_error_dialog_message), R.string.btn_logout, new StyledDialogFragment.OnDialogClickListener() {
                @Override
                public boolean onClick() {
                    DashboardActivity.startClearTop(SuperBaseCashierActivity.this);
                    return true;
                }
            }, null, null);
        ...
        if(isDefinedOnHold) {
            OnHoldListDialogFragment.show(this, this.orderGuid, this.orderTitle, OnHoldListDialogFragment.HoldOnAction.ADD_ORDER, new ArrayList<String>(itemsFragment.printerAlias()), new IHoldListener() {
                ...
                public void onSwap2Order(String holdName, String holdPhone, OnHoldStatus status, String nextOrderGuid, String definedOnHoldGuid) {
                    onSwap2OrderAction(SuperBaseCashierActivity.this.orderTitle, null, null, null, definedOnHoldGuid);
                }
            });
        } else {
    ...
    private void onSwap2OrderAction(String holdName, String holdPhone, OnHoldStatus status, String nextOrderGuid, String definedOnHoldGuid) {
        if (!TextUtils.isEmpty(orderGuid)) {
            UpdateSaleOrderOnRegisterCommand.start(getApplicationContext(), orderGuid, false);
            HoldOrderCommand.start(SuperBaseCashierActivity.this, holdOrderCallback, orderGuid, holdName, holdPhone, definedOnHoldGuid, status, HoldOrderCommand.HoldOnAction.ADD);
            UpdateSaleOrderItemMovementsCommand.start(SuperBaseCashierActivity.this, orderGuid);
        }
        setOrderGuid(nextOrderGuid, true);
    }
        ...
        AlertDialogFragment.showConfirmationNoImage(this,
                ...
                new StyledDialogFragment.OnDialogClickListener() {
                    ...
                    public boolean onClick() {
                        ...
                        PrintOrderToKdsCommand.start(SuperBaseCashierActivity.this, orderGuid, true, null);
                        RemoveSaleOrderCommand.start(SuperBaseCashierActivity.this, SuperBaseCashierActivity.this, SuperBaseCashierActivity.this.orderGuid);
                        return true;
                    }
                }
    ...
    public void onTax() {
        ...
        TaxEditFragment.show(this, orderGuid, saleOrderModel.taxable, new TaxEditFragment.SaleOrderTaxListener() {
            ...
            public void onAppliedTax(String orderGuid, boolean isTaxSwitch) {
                UpdateSaleOrderTaxStatusCommand.start(SuperBaseCashierActivity.this, orderGuid, isTaxSwitch,
                        new UpdateSaleOrderTaxStatusCommand.TaxCallback() {
                            @Override
                            protected void onSuccess(String orderGuid) {
                                Logger.d("[SaleOrder] onTaxUpdate");
    ...
    public void onVoidFailed(@Param(PrinterCommand.EXTRA_ERROR_PRINTER) PrinterCommand.PrinterError printerError,
        ...
        KitchenPrintCallbackHelper.IKitchenPrintCallback callback = new KitchenPrintCallbackHelper.IKitchenPrintCallback() {
            ...
            public void onSkip(String fromPrinter, boolean ignorePaperEnd, boolean searchByMac) {
                RemoveSaleOrderCommand.start(SuperBaseCashierActivity.this, SuperBaseCashierActivity.this, SuperBaseCashierActivity.this.orderGuid, true);
            }
        };
    ...
    public void onBarcodeReceived(String barcode) {
        if (barcodeListener != null) {
            ...
            Logger.d("SuperBaseCashierActivity: scannerListener: onBarcodeReceived(): ignored - barcode listener is not set!");
        }
    }
    ...
    private DisplayService.DisplayListener displayListener = new DisplayService.DisplayListener() {
        ...
        public void onError() {
            ...
            Toast.makeText(SuperBaseCashierActivity.this, R.string.error_message_display_command_error, Toast.LENGTH_SHORT).show();
        }
    ...
    private class OrdersCountLoader implements LoaderManager.LoaderCallbacks<OrdersStatInfo> {
        ...
        public Loader<OrdersStatInfo> onCreateLoader(int arg0, Bundle arg1) {
            ...
            return builder
                    ...
                    .build(SuperBaseCashierActivity.this);
        }
    ...
    protected BigDecimal getSaleItemAmount(String orderGuid) {
        ...
        Cursor c = ProviderAction.query(SALE_ITEM_ORDER_URI)
                ...
                .perform(SuperBaseCashierActivity.this);
    ...
    private class PrinterStatusCallback extends GetPrinterStatusCommand.BasePrinterStatusCallback {
        ...
        protected void onPrinterStatusError(PrinterCommand.PrinterError error) {
            ...
            AlertDialogFragment.showAlert(SuperBaseCashierActivity.this, R.string.check_drawer_state_error_dialog_title, getString(PrintCallbackHelper.getPrinterErrorMessage(error)), R.string.btn_retry,
                    new StyledDialogFragment.OnDialogClickListener() {
                        @Override
                        public boolean onClick() {
                            addItemModel(itemModel, modifierGiud, addonsGuids, optionalGuids, price, quantity, unit);
        ...
        protected void onPrinterIpNotFound() {
            ...
            AlertDialogFragment.showAlert(SuperBaseCashierActivity.this, R.string.check_drawer_state_error_dialog_title, getString(R.string.error_message_printer_ip_not_found), R.string.btn_ok,
                    new StyledDialogFragment.OnDialogClickListener() {
                        @Override
                        public boolean onClick() {
    ...
    private UpdateQtySaleOrderItemCommand.BaseUpdateQtySaleOrderItemCallback updateQtySaleOrderItemCallback = new UpdateQtySaleOrderItemCommand.BaseUpdateQtySaleOrderItemCallback() {
        ...
        protected void onSuccess(String saleItemGuid) {
            ...
            Log.d("BemaCarl15", "SuperBaseCashierActivity 2884");
    ...
    private void onScaleItemAdded(final SaleOrderItemModel item) {
        ...
        if (model!=null && scaleService.getStatus() == 0 && scaleService.isUnitsLabelMatch(model.unitsLabel)) {
            ...
            UpdateQtySaleOrderItemCommand.start(SuperBaseCashierActivity.this, item.getGuid(), item.qty.add(newQty), updateQtySaleOrderItemCallback);
        } else {
            ...
            alertDialogBuilder
                    ...
                    .setNeutralButton(getString(R.string.scale_dlg_warning_neutral_button), new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            dialog.cancel();
                            SettingsActivity.start(SuperBaseCashierActivity.this);
                        }
                    })
                    .setPositiveButton(getString(R.string.scale_dlg_warning_positive_button), new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            if (getOperatorPermissions().contains(Permission.CHANGE_QTY)) {
                                QtyEditFragment.showCancelable(SuperBaseCashierActivity.this, item.getGuid(),
                                        item.qty, item.priceType != PriceType.UNIT_PRICE, new QtyEditFragment.OnEditQtyListener() {
                                            @Override
                                            public void onConfirm(BigDecimal value) {
                                                UpdateQtySaleOrderItemCommand.start(SuperBaseCashierActivity.this,
                                                        item.getGuid(), item.qty.add(value), updateQtySaleOrderItemCallback);
                                            }
                                        });
                            } else {
                                PermissionFragment.showCancelable(SuperBaseCashierActivity.this, new StyledDialogFragment.OnDialogClickListener() {
                                            @Override
                                            public boolean onClick() {
                                                if (item.qty.equals(BigDecimal.ZERO)) {
                                                    ((IOrderItemListFragmentActions)getOrderItemListFragment()).doRemoceClickLine(item.getGuid());
                                        ...
                                        new BaseTempLoginListener(SuperBaseCashierActivity.this) {
                                            ...
                                            public void onLoginComplete() {
                                                super.onLoginComplete();
                                                QtyEditFragment.showCancelable(SuperBaseCashierActivity.this,
            ...
            Thread thread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (alertDialog.isShowing()) {
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                UpdateQtySaleOrderItemCommand.start(SuperBaseCashierActivity.this, item.getGuid(),
    ...
    public class AddItem2SaleOrderCallback extends AddItem2SaleOrderCommand.BaseAddItem2SaleOrderCallback {
        ...
        protected void onItemAdded(final SaleOrderItemModel item) {
            ...
            if (discountBundles != null && !discountBundles.isEmpty()){
                Log.d("BemaCarl15", "SuperBaseCashierActivity 3053");
                ApplyMultipleDiscountCommand.start(self(), orderGuid, new ArrayList<>(discountBundles));
            }
        }
    ...
    private class CheckOrderTask implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
            ...
            if (minCreateTime != null)
                builder.where(ShopStore.SaleOrderTable.CREATE_TIME + " >= ?", minCreateTime.getTime());
            return builder.build(SuperBaseCashierActivity.this);
        }
    ...
    public class GetItemsForFaickVoidCallback extends GetItemsForFakeVoidCommand.BaseGetItemsForFaickVoidCallback {
        ...
        protected void handleSuccess(ArrayList<MoneybackProcessor.RefundSaleItemInfo> result) {
            if (isFinishing() || isDestroyed()) {
                RevertSuccessOrderCommand.start(SuperBaseCashierActivity.this, orderGuid);
                EndTransactionCommand.start(SuperBaseCashierActivity.this);
                return;
            }
            ...
            MoneybackProcessor.create(orderGuid, OrderType.SALE)
                    .callback(new MoneybackProcessor.IRefundCallback() {
                        ...
                        public void onRefundFailure() {
                            AlertDialogFragment.show(SuperBaseCashierActivity.this, AlertDialogFragment.DialogType.ALERT, R.string.error_dialog_title, getString(R.string.return_order_create_error),
                                    R.string.btn_remove,
                                    new StyledDialogFragment.OnDialogClickListener() {
                                        @Override
                                        public boolean onClick() {
                    ...
                    .initRefundForFake(SuperBaseCashierActivity.this, refundAmount, transactions, getApp().getBlackStoneUser(), true);
        }
        ...
        protected void handleFailure() {
            ...
            WaitDialogFragment.hide(SuperBaseCashierActivity.this);
            AlertDialogFragment.showAlert(SuperBaseCashierActivity.this, R.string.error_dialog_title, getString(R.string.error_something_wrong));
        }
    }
    ...
    public class SuccessOrderCommand4ReturnCallback extends SuccessOrderCommand.BaseSuccessOrderCommandCallback {
        ...
        @Override
        protected void handleSuccess() {
            GetItemsForFakeVoidCommand.start(SuperBaseCashierActivity.this, orderGuid, new GetItemsForFaickVoidCallback());
        }
    ...
    private class CheckOrderPaymentsLoader implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
            CursorLoaderBuilder builder = CursorLoaderBuilder.forUri(PAYMENTS_URI)
                    .projection("1")
                    .where(ShopStore.PaymentTransactionTable.ORDER_GUID + " = ?", SuperBaseCashierActivity.this.orderGuid)
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor c) {
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    if (hasPayments) {
                        AlertDialogFragment.showAlert(SuperBaseCashierActivity.this, R.string.error_dialog_title, getString(R.string.error_message_has_payments));
                        return;
                    }
...
//                    getSupportLoaderManager().restartLoader(LOADER_CHECK_ITEM_PRINT_STATUS, null, checkItemPrintStatusLoader);
    ...
    private Runnable tbpLoadTask = new Runnable() {
        ...
        public void run() {
            ...
            if (!SuperBaseCashierActivity.this.priceLevels.equals(priceLevels)){
                SuperBaseCashierActivity.this.priceLevels = priceLevels;
                handler.post(new Runnable() {
                    @Override
                    public void run() {
