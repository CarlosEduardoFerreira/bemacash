...
public final class CalculationUtil {
    ...
    private final static int RESULT_SCALE = 3;
    private final static int QUANTITY_SCALE = 3;
    private final static RoundingMode MONEY_ROUNDING = RoundingMode.UP;
    ...
    public static BigDecimal getTaxVatValueNoScale(BigDecimal itemSubTotal, BigDecimal taxVATPercent) {
        if(taxVATPercent == null)
            return BigDecimal.ZERO;
        BigDecimal result = itemSubTotal.multiply(taxVATPercent.divide(ONE_HUNDRED, 4, MONEY_ROUNDING));
        return result;
    }
