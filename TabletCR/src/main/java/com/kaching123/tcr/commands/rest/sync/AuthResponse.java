...
public class AuthResponse extends JsonResponse {
    ...
    public AuthInfo getResponse() {
        try {
            ...
            boolean key_register_null = KEY_REGISTER == null;
            boolean key_employee_null = KEY_EMPLOYEE == null;
            if(key_register_null || key_employee_null)
                return null;
            ...
            return new AuthInfo( key_register_null ? null : registerModel, key_employee_null ? null : employeeModel);
