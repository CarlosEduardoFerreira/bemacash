 ...
 */
public class PaxBlackstoneRefundCommand extends PaxBlackstoneBaseCommand {
    ...
    public static final TaskHandler startReturn(Context context,
        ...
        return  create(PaxBlackstoneRefundCommand.class)
    ...
    public static abstract class PaxREFUNDCommandBaseCallback {
        ...
        @OnSuccess(PaxBlackstoneRefundCommand.class)
        public final void onSuccess(@Param(AddReturnOrderCommand.RESULT_CHILD_ORDER_MODEL) SaleOrderModel childOrderModel,
                                    @Param(PaxBlackstoneRefundCommand.ARG_TRANSACTION_MODEL) PaymentTransactionModel childTransactionModel,
                                    @Param(PaxBlackstoneRefundCommand.RESULT_ERROR_REASON) String errorMessage,
                                    @Param(PaxBlackstoneRefundCommand.ARG_TRANSACTION) Transaction transaction) {
        ...
        @OnFailure(PaxBlackstoneRefundCommand.class)
