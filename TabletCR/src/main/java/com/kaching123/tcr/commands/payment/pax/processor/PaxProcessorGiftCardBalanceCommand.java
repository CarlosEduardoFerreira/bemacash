 ...
 * Created by mayer
 */
public class PaxProcessorGiftCardBalanceCommand extends PaxProcessorBaseCommand {
    ...
    public static final TaskHandler start(Context context,
        ...
        return create(PaxProcessorGiftCardBalanceCommand.class)
    ...
    public static abstract class PaxBalanceCommandBaseCallback {
        ...
        @OnSuccess(PaxProcessorGiftCardBalanceCommand.class)
        public final void onSuccess(@Param(PaxProcessorGiftCardBalanceCommand.RESULT_AMOUNT) BigDecimal result,
                                    @Param(PaxProcessorGiftCardBalanceCommand.RESULT_LAST4) String last4,
                                    @Param(PaxProcessorGiftCardBalanceCommand.RESULT_ERROR_REASON) String errorReason) {
        ...
        @OnFailure(PaxProcessorGiftCardBalanceCommand.class)
