 ...
 * Created by mayer
 */
public class PaxLastTransactionCommand extends PaxBaseCommand {
    ...
    public static final TaskHandler startSale(Context context,
        ...
        return  create(PaxLastTransactionCommand.class)
    ...
    public static abstract class PaxSaleCommandBaseCallback {
        ...
        @OnSuccess(PaxLastTransactionCommand.class)
        ...
        @OnFailure(PaxLastTransactionCommand.class)
