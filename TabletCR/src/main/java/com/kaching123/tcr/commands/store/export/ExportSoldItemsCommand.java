 ...
 */
public class ExportSoldItemsCommand extends ExportCursorToFileCommand {
    ...
    protected String getFileName() {
        return orderType == null ? "Sold_Items_Export" : "Prepaid_Sold_Items_Export";
    }
    ...
    protected List<Object> readRow(Cursor c) {
        ArrayList<Object> result = new ArrayList<Object>(15);
        result.add(c.getString(0));
        result.add(new Date(c.getLong(1)));
        result.add(c.getString(2));
        result.add(c.getString(3));//description
