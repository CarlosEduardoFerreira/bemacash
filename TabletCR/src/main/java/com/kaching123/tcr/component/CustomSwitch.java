...
public class CustomSwitch extends CompoundButton {
     ...
     * @param defStyle An attribute ID within the active theme containing a reference to the default style for this widget. e.g. android.R.attr.switchStyle.
     */
     ...
     *
     * @param textRight The right text
     */
