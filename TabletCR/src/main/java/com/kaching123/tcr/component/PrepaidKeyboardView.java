...
@EViewGroup(R.layout.component_prepaid_keyboard_view)
public class PrepaidKeyboardView extends FrameLayout {
    ...
    public PrepaidKeyboardView(Context context) {
        super(context);
    }

    public PrepaidKeyboardView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PrepaidKeyboardView(Context context, AttributeSet attrs, int defStyle) {
