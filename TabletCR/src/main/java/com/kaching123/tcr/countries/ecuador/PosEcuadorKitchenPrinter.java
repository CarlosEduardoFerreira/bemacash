...
public class PosEcuadorKitchenPrinter extends PosEcuadorOrderTextPrinter implements IKitchenPrinter {
    ...
    public void header(String shopName, String registerTitle, String orderTypeLabel, String orderType, String orderNumLabel, int orderSeqNum,
                       String operatorLabel, String operatorName, String stationLabel, String station, String orderHolder,
                       String orderTitle, String phoneLabel, String phone, String customerLabel, String customerName) {
