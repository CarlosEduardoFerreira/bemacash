...
public class PosPuertoricoKitchenPrinter extends PosPuertoricoOrderTextPrinter implements IKitchenPrinter {
    public static final int PRINTER_KITCHEN_MAX_TEXT_LEN = 39;

    public PosPuertoricoKitchenPrinter() {
    ...
    public void header(String shopName, String registerTitle, String orderTypeLabel, String orderType, String orderNumLabel, int orderSeqNum,
                       String operatorLabel, String operatorName, String stationLabel, String station,
