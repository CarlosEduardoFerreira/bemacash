 ...
 */
public class UsbScannerDriverUSA implements UsbSerialDriver {

    private final String TAG = UsbScannerDriverUSA.class.getSimpleName();
    ...
    class CdcAcmSerialPort extends CommonUsbSerialPort {
        ...
        public UsbSerialDriver getDriver() {
            return UsbScannerDriverUSA.this;
        }
