...
public class UsbSerialProber {
    ...
    public static ProbeTable getDefaultProbeTable() {
        ...
        probeTable.addDriver(UsbScannerDriverUSA.class);
        probeTable.addDriver(UsbScannerDriverBR.class);

        probeTable.addProduct(0x0202, 0x0B94, CdcAcmSerialDriver.class);
        probeTable.addProduct(0x0202, 0x00f4, CdcAcmSerialDriver.class);

        probeTable.addProduct(0x24EA, 0x0187, UsbScannerDriverUSA.class);      //  Bematech D-7500 Scanner USA

        probeTable.addProduct(0x24EA, 0x0197, UsbScannerDriverBR.class);      //  Bematech D-7500 Scanner BR
